...
class GlobalTestOpenAcademySession(TransactionCase):
    ...
    #    })
    #
    #    self.assertEqual(session_test.state,'draft', 'Initial state shuld be in "draft"')
    #
    #    session_test.signal_workflow(button_confirm)
    #    self.assertEqual(session_test_state, 'confirmed', "Signal confirm don't work fine!")
    #    #print("*** Session_test.Status:", session_test.status)
    #
    #    session_test.signal_workflow(button_done)
    #    self.assertEqual(session_test_state, 'done', "Signal done don't work fine!")
    #    self.evv.cr.commit() # Just to test the data generated by the test. Please don't use!
